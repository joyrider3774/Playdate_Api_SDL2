...
#include "SDL_gfxPrimitivesSurface.h"
...
\returns Returns 0 on success, -1 on failure.
*/
int pixelColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y, Uint32 color)
{
	Uint8 alpha;
	Uint32 mcolor;
	int result = 0;
...
int pixelColorWeight(SDL_Surface * dst, Sint16 x, Sint16 y, Uint32 color, Uint32 weight)
{
	...
	*/
	...
	return (pixelColorSurface(dst, x, y, (color & (Uint32) 0xffffff00) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int pixelRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	Uint32 color;
	...
	*/
	if (a == 255) {
		...
		* Draw 
		*/
		return (pixelColorSurface(dst, x, y, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
	}
}
...
\returns Returns 0 on success, -1 on failure.
*/
int hlineColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 x2, Sint16 y, Uint32 color)
{
	Sint16 left, right, top, bottom;
	Uint8 *pixel, *pixellast;
	int dx;
...
\returns Returns 0 on success, -1 on failure.
*/
int hlineRGBASurface(SDL_Surface * dst, Sint16 x1, Sint16 x2, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (hlineColorSurface(dst, x1, x2, y, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int vlineColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y1, Sint16 y2, Uint32 color)
{
	Sint16 left, right, top, bottom;
	Uint8 *pixel, *pixellast;
	int dy;
...
\returns Returns 0 on success, -1 on failure.
*/
int vlineRGBASurace(SDL_Surface * dst, Sint16 x, Sint16 y1, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (vlineColorSurface(dst, x, y1, y2, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int rectangleColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color)
{
	int result;
	Sint16 tmp;
	...
	*/
	if (x1 == x2) {
		if (y1 == y2) {
			return (pixelColorSurface(dst, x1, y1, color));
		} else {
			return (vlineColorSurface(dst, x1, y1, y2, color));
		}
	} else {
		if (y1 == y2) {
			return (hlineColorSurface(dst, x1, x2, y1, color));
		}
	}
	...
	*/
	result = 0;
	result |= hlineColorSurface(dst, x1, x2, y1, color);
	result |= hlineColorSurface(dst, x1, x2, y2, color);
	y1 += 1;
	y2 -= 1;
	if (y1 <= y2) {
		result |= vlineColorSurface(dst, x1, y1, y2, color);
		result |= vlineColorSurface(dst, x2, y1, y2, color);
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int rectangleRGBASurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (rectangleColorSurface
...
\returns Returns 0 on success, -1 on failure.
*/
int roundedRectangleColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 rad, Uint32 color)
{
	int result;
	Sint16 w, h, tmp;
	...
	*/
	if (rad == 0) {
		return rectangleColorSurface(dst, x1, y1, x2, y2, color);
	}
	...
	*/
	...
	yy1 = y1 + rad;
	yy2 = y2 - rad;
	result |= arcColorSurface(dst, xx1, yy1, rad, 180, 270, color);
	result |= arcColorSurface(dst, xx2, yy1, rad, 270, 360, color);
	result |= arcColorSurface(dst, xx1, yy2, rad,  90, 180, color);
	result |= arcColorSurface(dst, xx2, yy2, rad,   0,  90, color);

	/*
	* Draw lines
	*/
	if (xx1 <= xx2) {
		result |= hlineColorSurface(dst, xx1, xx2, y1, color);
		result |= hlineColorSurface(dst, xx1, xx2, y2, color);
	}
	if (yy1 <= yy2) {
		result |= vlineColorSurface(dst, x1, yy1, yy2, color);
		result |= vlineColorSurface(dst, x2, yy1, yy2, color);
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int roundedRectangleRGBASurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (roundedRectangleColorSurface
...
\returns Returns 0 on success, -1 on failure.
*/
int roundedBoxColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 rad, Uint32 color)
{
	int result;
	Sint16 w, h, tmp;
	Sint16 xx1, xx2, yy1, yy2;
	...
	*/
	...
	yy1 = y1 + rad;
	yy2 = y2 - rad;
	result |= filledPieColorSurface(dst, xx1, yy1, rad, 180, 270, color);
	result |= filledPieColorSurface(dst, xx2, yy1, rad, 270, 360, color);
	result |= filledPieColorSurface(dst, xx1, yy2, rad,  90, 180, color);
	result |= filledPieColorSurface(dst, xx2, yy2, rad,   0,  90, color);
	...
	*/
	...
	yy2--;
	if (xx1 <= xx2) {
		result |= boxColorSurface(dst, xx1, y1, xx2, y2, color);
	}
	if (yy1 <= yy2) {
		result |= boxColorSurface(dst, x1, yy1, xx1-1, yy2, color);
		result |= boxColorSurface(dst, xx2+1, yy1, x2, yy2, color);
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int roundedBoxRGBASurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2,
	Sint16 y2, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (roundedBoxColorSurface
		(dst, x1, y1, x2, y2, rad, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int boxColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color)
{
	Sint16 left, right, top, bottom;
	Uint8 *pixel, *pixellast;
	int x, dx;
...
\returns Returns 0 on success, -1 on failure.
*/
int boxRGBASurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (boxColorSurface(dst, x1, y1, x2, y2, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int lineColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color)
{
	int pixx, pixy;
	int x, y;
	int dx, dy;
	...
	*/
	if (x1 == x2) {
		if (y1 < y2) {
			...
			return (vlineColorSurface(dst, x1, y2, y1, color));
		} else {
			return (pixelColorSurface(dst, x1, y1, color));
		}
	}
	if (y1 == y2) {
		if (x1 < x2) {
			...
			return (hlineColorSurface(dst, x2, x1, y1, color));
		}
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int lineRGBASurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (lineColorSurface(dst, x1, y1, x2, y2, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
	...
	if (dx == 0) {
		...
		*/
		if (draw_endpoint)
		{
			...
			if (dy>0) {
				return (vlineColorSurface(dst, x1, yy0, yy0+dy, color));
			} else {
				return (pixelColorSurface(dst, x1, y1, color));
			}
		}
		...
		*/
		if (draw_endpoint)
		{
			...
			if (dx!=0) {
				return (hlineColorSurface(dst, xx0, xx0+dx, y1, color));
			} else {
				return (pixelColorSurface(dst, x1, y1, color));
			}
		}
		...
		*/
		return (lineColorSurface(dst, x1, y1, x2, y2, color));
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int aalineColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color)
{
...
\returns Returns 0 on success, -1 on failure.
*/
int aalineRGBASurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return (_aalineColor
...
\returns Returns 0 on success, -1 on failure.
*/
int circleColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Uint32 color)
{
	Sint16 left, right, top, bottom;
	int result;
	Sint16 x1, y1, x2, y2;
	...
	*/
	if (rad == 0) {
		return (pixelColorSurface(dst, x, y, color));
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int circleRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (circleColorSurface(dst, x, y, rad, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int arcColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Uint32 color)
{
	Sint16 left, right, top, bottom;
	int result;
	Sint16 x1, y1, x2, y2;
...
\returns Returns 0 on success, -1 on failure.
*/
int arcRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (arcColorSurface(dst, x, y, rad, start, end, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aacircleColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Uint32 color)
{
	return (aaellipseColorSurface(dst, x, y, rad, rad, color));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aacircleRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (aaellipseColorSurface
...
\returns Returns 0 on success, -1 on failure.
*/
int filledCircleColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Uint32 color)
{
	Sint16 left, right, top, bottom;
	int result;
	Sint16 x1, y1, x2, y2;
	...
	do {
		...
		if (ocy != cy) {
			if (cy > 0) {
				ypcy = y + cy;
				ymcy = y - cy;
				result |= hlineColorSurface(dst, xmcx, xpcx, ypcy, color);
				result |= hlineColorSurface(dst, xmcx, xpcx, ymcy, color);
			} else {
				result |= hlineColorSurface(dst, xmcx, xpcx, y, color);
			}
			ocy = cy;
		}
		if (ocx != cx) {
			if (cx != cy) {
				if (cx > 0) {
					ypcx = y + cx;
					ymcx = y - cx;
					result |= hlineColorSurface(dst, xmcy, xpcy, ymcx, color);
					result |= hlineColorSurface(dst, xmcy, xpcy, ypcx, color);
				} else {
					result |= hlineColorSurface(dst, xmcy, xpcy, y, color);
				}
			}
			ocx = cx;
		}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledCircleRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (filledCircleColorSurface
...
\returns Returns 0 on success, -1 on failure.
*/
int ellipseColorSurace(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color)
{
	Sint16 left, right, top, bottom;
	int result;
	Sint16 x1, y1, x2, y2;
	...
	*/
	if (rx == 0) {
		return (vlineColorSurface(dst, x, y - ry, y + ry, color));
	}
	/*
	* Special case for ry=0 - draw a hline 
	*/
	if (ry == 0) {
		return (hlineColorSurface(dst, x - rx, x + rx, y, color));
	}
			...
			do {
				...
				if (((ok != k) && (oj != k)) || ((oj != j) && (ok != j)) || (k != j)) {
					...
					if (j > 0) {
						...
						result |= pixelColorSurface(dst, xpi, ymj, color);
					} else {
...
\returns Returns 0 on success, -1 on failure.
*/
int ellipseRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (ellipseColorSurace(dst, x, y, rx, ry, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aaellipseColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color)
{
	Sint16 left, right, top, bottom;
	Sint16 x1,y1,x2,y2;
	int i;
...
\returns Returns 0 on success, -1 on failure.
*/
int aaellipseRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
...
\returns Returns 0 on success, -1 on failure.
*/
int filledEllipseColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color)
{
	Sint16 left, right, top, bottom;
	int result;
	Sint16 x1, y1, x2, y2;
	...
	if (rx > ry) {
		...
		do {
			...
			if ((ok != k) && (oj != k)) {
				...
				xmh = x - h;
				if (k > 0) {
					result |= hlineColorSurface(dst, xmh, xph, y + k, color);
					result |= hlineColorSurface(dst, xmh, xph, y - k, color);
				} else {
					result |= hlineColorSurface(dst, xmh, xph, y, color);
				}
				ok = k;
			}
			if ((oj != j) && (ok != j) && (k != j)) {
				...
				xpi = x + i;
				if (j > 0) {
					result |= hlineColorSurface(dst, xmi, xpi, y + j, color);
					result |= hlineColorSurface(dst, xmi, xpi, y - j, color);
				} else {
					result |= hlineColorSurface(dst, xmi, xpi, y, color);
				}
				oj = j;
			}
		...
		do {
			...
			if ((oi != i) && (oh != i)) {
				...
				xpj = x + j;
				if (i > 0) {
					result |= hlineColorSurface(dst, xmj, xpj, y + i, color);
					result |= hlineColorSurface(dst, xmj, xpj, y - i, color);
				} else {
					result |= hlineColorSurface(dst, xmj, xpj, y, color);
				}
				oi = i;
			}
			if ((oh != h) && (oi != h) && (i != h)) {
				...
				xpk = x + k;
				if (h > 0) {
					result |= hlineColorSurface(dst, xmk, xpk, y + h, color);
					result |= hlineColorSurface(dst, xmk, xpk, y - h, color);
				} else {
					result |= hlineColorSurface(dst, xmk, xpk, y, color);
				}
				oh = h;
			}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledEllipseRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (filledEllipseColorSurface
		(dst, x, y, rx, ry, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
int _pieColor(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Uint32 color, Uint8 filled)
{
	...
	*/
	...
	if (numpoints<3)
	{
		result = lineColorSurface(dst, vx[0], vy[0], vx[1], vy[1], color);
	}
	else
	{
		...
		/* Draw */
		if (filled) {
			result = filledPolygonColorSurface(dst, vx, vy, numpoints, color);
		} else {
			result = polygonColorSurface(dst, vx, vy, numpoints, color);
		}
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int pieColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, 
...
\returns Returns 0 on success, -1 on failure.
*/
int pieRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad,
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPieColorSurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Uint32 color)
{
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPieRGBASurface(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad,
	Sint16 start, Sint16 end, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return (_pieColor(dst, x, y, rad, start, end,
...
\returns Returns 0 on success, -1 on failure.
*/
int trigonColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Uint32 color)
{
	Sint16 vx[3]; 
	Sint16 vy[3];
	...
	return(polygonColorSurface(dst,vx,vy,3,color));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int trigonRGBASurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3,
	Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	return(polygonRGBASurface(dst,vx,vy,3,r,g,b,a));
}				 
...
\returns Returns 0 on success, -1 on failure.
*/
int aatrigonColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Uint32 color)
{
	Sint16 vx[3]; 
	Sint16 vy[3];
	...
	return(aapolygonColorSurface(dst,vx,vy,3,color));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aatrigonRGBASurface(SDL_Surface * dst,  Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3,
	Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	Sint16 vx[3]; 
	Sint16 vy[3];
	...
	return(aapolygonRGBASurface(dst,vx,vy,3,r,g,b,a));
}				   
...
\returns Returns 0 on success, -1 on failure.
*/
int filledTrigonColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Uint32 color)
{
	Sint16 vx[3]; 
	Sint16 vy[3];
	...
	return(filledPolygonColorSurface(dst,vx,vy,3,color));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledTrigonRGBASurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3,
	Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	Sint16 vx[3]; 
	Sint16 vy[3];
	...
	return(filledPolygonRGBASurface(dst,vx,vy,3,r,g,b,a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int polygonColorSurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color)
{
	int result;
	int i;
	...
	*/
	result = 0;
	for (i = 1; i < n; i++) {
		result |= lineColorSurface(dst, *x1, *y1, *x2, *y2, color);
		x1 = x2;
		y1 = y2;
		x2++;
		y2++;
	}
	result |= lineColorSurface(dst, *x1, *y1, *vx, *vy, color);
...
\returns Returns 0 on success, -1 on failure.
*/
int polygonRGBASurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (polygonColorSurface(dst, vx, vy, n, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aapolygonColorSurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color)
{
	int result;
	int i;
	const Sint16 *x1, *y1, *x2, *y2;
...
\returns Returns 0 on success, -1 on failure.
*/
int aapolygonRGBASurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (aapolygonColorSurface(dst, vx, vy, n, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPolygonColorMTSurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color, int **polyInts, int *polyAllocated)
{
	int result;
	int i;
	int y, xa, xb;
	...
	*/
	...
	for (y = miny; (y <= maxy); y++) {
		...
		for (i = 0; (i < ints); i += 2) {
			...
			result |= hlineColorSurface(dst, xa, xb, y, color);
		}
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPolygonRGBAMTSurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a, int **polyInts, int *polyAllocated)
{
	/*
	* Draw 
	*/
	return (filledPolygonColorMTSurface(dst, vx, vy, n, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a, polyInts, polyAllocated));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPolygonColorSurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color)
{
	/*
	* Draw 
	*/
	return (filledPolygonColorMTSurface(dst, vx, vy, n, color, NULL, NULL));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPolygonRGBASurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (filledPolygonColorMTSurface(dst, vx, vy, n, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a, NULL, NULL));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int texturedPolygonMTSurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, 
...
\returns Returns 0 on success, -1 on failure.
*/
int texturedPolygonSurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, SDL_Surface *texture, int texture_dx, int texture_dy)
{
	/*
	* Draw
	*/
	return (texturedPolygonMTSurface(dst, vx, vy, n, texture, texture_dx, texture_dy, NULL, NULL));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int bezierColorSurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, int s, Uint32 color)
{
	int result;
	int i;
...
\returns Returns 0 on success, -1 on failure.
*/
int bezierRGBASurface(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, int s, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
	return (bezierColorSurface(dst, vx, vy, n, s, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a));
}
	...
	if (miter > 1) {
		if (m->first1x != -32768) {
			...
			*/
			...
			py[2] = ml1by;
			py[3] = ml2by;			
			polygonColorSurface(m->dst, (Sint16 *)px, (Sint16 *)py, 4, m->color);						
		}
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int thickLineColorSurface(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 width, Uint32 color)
{	
	int wh;
	...
	if ((x1 == x2) && (y1 == y2)) {
		wh = width / 2;
		return boxColorSurface(dst, x1 - wh, y1 - wh, x2 + width, y2 + width, color);		
	}
