...
bool stubDoQuit;
bool pd_api_gfx_disable_masks = true; // THEY DO NOT WORK ! i only added it for my puzzleland game which is basic usage (it only creates a masked image when calling setmask)
